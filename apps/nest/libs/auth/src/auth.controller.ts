...
export class AuthController {
  ...
  @Get('siwe/nonce')
  @HttpCode(HttpStatus.OK)
  @ApiOkResponse({ description: 'Return a one-time nonce for SIWE (stored server-side).' })
  ...
  async verifySiweSignature(@Body() dto: VerifySiweDto): Promise<TokenResDto> {
    return this.authService.loginWithWallet(dto.message, dto.signature)
  }
}
